...
class CommunityAboutComponent extends React.Component{
                    ...
                    >
                        <div className='modal_container' >
                            ...
                            <div className="modal_top_component" style={{display:'flex', justifyContent:'center'}}>
                                <input type="file"  name="file"  onChange={event => this.getFile(event.target.files, "imageURL")}/>
                            </div>
    ...
    render(){
        ...
        return(
            <div className="dedicated_content_container" style={{display:'grid', alignContent:'center', rowGap:'2vh'}}>
                <div>
                    <p style={{textAlign:'center', fontSize: FontSizes.size18, fontWeight:FontWeights.regular}}>Info</p>
                ...
                <div className="topic_image_container community_about_container"  >
                    <p style={{textAlign:'center', fontSize: FontSizes.size16, fontWeight:FontWeights.regular}}>Community Pic</p>
                ...
                <div className="topic_image_container community_about_container">
                    <p style={{color: '',textAlign:'center', fontSize: FontSizes.size16, fontWeight:FontWeights.regular}}>Community Background</p>               
                ...
                <div className="topic_image_container community_about_container">
                    {(this.state.community.role === "MODERATOR")? <DefaultButton style={{margin:'auto'}}  text="Submit Changes" onClick={()=> this.submitChanges()}/> : null}
                </div>
