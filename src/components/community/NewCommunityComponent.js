            ...
            <div>
                ...
                <div className="profile_center_component">
                    <div className='profile_background_image_container'>
                        <img className='profile_background_image' alt="BACKGROUD"src= {(typeof this.state.community.backgroundImageURL !== 'undefined' &&  this.state.community.backgroundImageURL !== null) ? this.state.community.backgroundImageURL: "https://www.beautycolorcode.com/2f2f2f-1440x900.png"} />
                    </div>
                            ...
                            <div className='profile_container'>
                                ...
                                <div >
                                    <ButtonGroup size="large" variant="text" >
                                        ...
                                        >Followers <p style={{color:'#aaadb1'}}>{this.state.community.followers}</p> </Button>
                                        
                                        <Button style={{display:'grid',lineHeight:'7px', fontSize:'15px'}} color={this.state.membersOption === true? "primary": "default"}
                                             onClick={() => this.setState({
                                                topics: false,
                                                followers: false,
                                                mods: false,
                                        ...
                                        >Members <p style={{color:'#aaadb1'}}>{this.state.community.members}</p></Button>

                                         {/* <p style={{color:'#aaadb1'}}>{this.state.profile.following}</p> */}

                                         <Button style={{display:'grid',lineHeight:'7px', fontSize:'15px'}} color={this.state.mods === true? "primary": "default"}
                                            onClick={() => this.setState({
                                                topics: false,
                                                followers: false,
                                                mods: true,
                                        ...
                                        >Moderators <p style={{color:'#aaadb1'}}>{this.state.community.mods}</p></Button>
                                    </ButtonGroup>
                                </div>
                            </div>
                            <div className='options_container'>
                                <Button variant="outlined" style={{gridColumn:'1', gridRow:'1'}} className='option_content'
                                    onClick={() => this.setState({
                                        topics: false,
                                        followers: false,
                                        membersOption: false,
                                ...
                                <Button  variant={this.state.community === true? "filled":"outlined"} style={{gridColumn:'2', gridRow: '1', backgroundColor:(this.state.related === true ? "#303741" : 'transparent')}} className='option_content' 
                                    onClick={() => this.setState({
                                        topics: false,
                                        followers: false,
                                        membersOption: false,
