        ...
        return (
            <div className="profile_bar_container">
                <div className="profile_bar_background_image_container">
                    <img className="profile_bar_background_image" alt="logo"
                         src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4w-mN9-DqN_kQlRYJ-xggDC3RAqsPoum4dQ&usqp=CAU"/>
                </div>
