...
class NotificationComponent extends React.Component{
    ...
    render(){
        return(
            <div>
                <ButtonGroup>
                    <Button color={this.state.messageOption === true? "primary": "default"} onClick={() => this.setState({
                        messageOption: true,
                        topicOption: false,
                        communitiesOption: false,
                        page: null,
                    ...
                    <Button color={this.state.topicsOption === true? "primary": "default"} onClick={() => this.setState({
                        messageOption: false,
                        topicOption: true,
                        communitiesOption: false,
                        page: null,
                    ...
                    <Button color={this.state.communitiesOption === true? "primary": "default"} onClick={() => this.setState({
                        messageOption: false,
                        topicOption: true,
                        communitiesOption: false,
                        page: null,
